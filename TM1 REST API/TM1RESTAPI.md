...
**This section covers the basics of the TM1 REST API to help you get started. For a detailed overview of OData query options and operations, refer to [*ODATARESTAPI.md*](/TM1%20REST%20API/ODATA-TM1RESTAPI.md)**
